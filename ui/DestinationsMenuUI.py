...
class DestinationsMenu():
    ...
    def header(self, title):
        ...
        print("\n {}\n \n {} \n    ".format("*"*65, "{}{}{}".format(" "*25, title, " "*30), "-"*65))
    ...
    def get_destination(self, destination_id):
        ...
        while input_command != 'q':
            ...
            print('{} Airport{:^33}{} km\n'.format(one_destination.get_destination() ,one_destination.get_country() ,one_destination.get_distance()))
            print('{:^13}{:^38}{:^14}{}'.format('Contact name ','Emergency number','Flight time', 'Destination Number'))
